...
document.addEventListener('DOMContentLoaded', function (e) {
    (function () {
        ...
        if (accountUserImage) {
            ...
            fileInput.onchange = () => {
                ...
                {
                    accountUserImage.style.display = 'none';
                }
            };
    ...
    (function () {
        // Update/reset user image of account page
        let logoImage = document.getElementById('uploadedLogo');
        const logoInput = document.querySelector('.logo-file-input'),
            resetLogoInput = document.querySelector('#logo-image-reset');

        if (logoImage) {
            const resetImage = logoImage.src;
            logoInput.onchange = () => {
            ...
            if (resetLogoInput) {
                resetLogoInput.onclick = () => {
                    logoInput.value = '';
                    logoImage.src = resetImage;
                };
            }
        }
    })();
